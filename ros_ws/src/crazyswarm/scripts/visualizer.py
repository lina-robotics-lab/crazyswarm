...
class Visulizer(object):
    ...
    def __init__(self, shared_locs, lock):
        ...
        workspace = '/home/mht/csw_ws/crazyswarm/ros_ws/src/crazyswarm/traj_data/real_base_double'
        # for param in [env]:
        with open(workspace + "/params.yaml") as file:
    ...
    def render(self,  **kwargs): # real_x=0, real_y=0,
        ...
        def draw_coverage(center, color='blue'):
            grid_size = self.grid_size
            # center = self.grid_V[idx]
            glBegin(GL_POLYGON)
            gl_color_helper(color)
